...
SHOTS: list[dict] = [
    ...
    dict(name="collapse", a="s03-collapse.png", b="s03b-collapse.png", motion="cut", move=0.0,
         dur=6.0, flicker=0.012, framings=[
             ...
             (0.14, 1.10, 1.16, 650, -150, 0, "s05-disdain.png"),
             (0.18, 1.15, 1.22, 0, 100, 3, "s03c-collapse.png"),
         ]),
    ...
    dict(name="disdain", a="s05-disdain.png", b="s05b-disdain.png", motion="morph", move=0.40,
         dur=10.0, flicker=0.012, framings=[
             (0.28, 1.00, 1.06, 350, 0, 0),
             (0.16, 1.35, 1.42, 700, -180, 0),
             (0.18, 1.28, 1.34, -300, 200, 0, "s03-collapse.png"),
             (0.16, 1.42, 1.48, 700, -160, 0),
             (0.22, 1.10, 1.18, 420, 0, 0),
         ]),
    dict(name="shadow", a="s06-shadow.png", b="s06b-shadow.png", motion="morph", move=0.45,
         dur=10.0, flicker=0.016, framings=[
             (0.20, 1.00, 1.08, -345, 0, 0),
             (0.16, 1.15, 1.22, 0, -80, 0, "s06c-shadow.png"),
             (0.24, 1.20, 1.30, -345, 100, 0),
             (0.18, 1.40, 1.46, -30, -160, 0, "s06c-shadow.png"),
             (0.22, 1.05, 1.14, -250, 0, 0),
         ]),
